...
public class TestRegex {
	...
	public static DiffType accept() {
		...
		String text = "import static com.covansys.jclarety.arch.common.base.BusinessException.newBusinessException;";

		Matcher importMatcher = IMPORT_MATCHER.get();

		System.out.println(importMatcher.reset(text).find());
