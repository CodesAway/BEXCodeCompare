...
public class JavaCompareUtilities {
	...
	static String getString(final ResourceBundle bundle, final String key, final String dfltValue) {
		//		System.out.println(getMethodName() + "\t" + bundle);
		...
		if (bundle != null) {
			try {
				...
				// NeedWork
				//				System.out.println(getMethodName() + "\t" + "Exception");
			}
		}
		return dfltValue;
	}
	...
	static int getInteger(final ResourceBundle bundle, final String key, final int dfltValue) {
		//		System.out.println(getMethodName() + "\t" + bundle);

		if (bundle != null) {
			try {
				String s = bundle.getString(key);
				//				System.out.println(getMethodName() + "\t" + s);
	...
	static ImageDescriptor getImageDescriptor(final IMember element) {
	 ...
	 */
	static String getJavaElementID(final IJavaElement je) {
	...
	static boolean getBoolean(final CompareConfiguration cc, final String key, final boolean dflt) {
		if (cc != null) {
	...
	static Image getImage(final IMember member) {
	...
	static JavaTextTools getJavaTextTools() {
		...
		//		System.out.println(getMethodName() + "\t" + plugin);
		if (plugin != null) {
	...
	static IDocumentPartitioner createJavaPartitioner() {
		...
		//		System.out.println(getMethodName() + "\t" + tools);
		if (tools != null) {
	 ...
	 */
	static void initAction(final IAction a, final ResourceBundle bundle, final String prefix) {
	...
	static void initToggleAction(final IAction a, final ResourceBundle bundle, final String prefix,
	 ...
	 */
	public static boolean isCompareEditorInput(final IEditorInput input) {
