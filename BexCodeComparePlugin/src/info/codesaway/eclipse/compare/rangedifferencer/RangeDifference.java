...
public class RangeDifference {
	 ...
	 * @since org.eclipse.compare.core 3.5
	 */
	protected RangeDifference(final int changeKind) {
	 ...
	 * @since org.eclipse.compare.core 3.5
	 */
	protected RangeDifference(final int kind, final int rightStart, final int rightLength, final int leftStart,
	...
	protected RangeDifference(final int kind, final int rightStart, final int rightLength, final int leftStart,
			final int leftLength,
			final int ancestorStart, final int ancestorLength) {
	...
	public String toString() {
		...
		buf.append("Left: " + this.toRangeString(this.leftStart, this.leftLength) + " Right: " //$NON-NLS-1$//$NON-NLS-2$
				+ this.toRangeString(this.rightStart, this.rightLength));
		if (this.ancestorLength > 0 || this.ancestorStart > 0) {
			buf.append(" Ancestor: " + this.toRangeString(this.ancestorStart, this.ancestorLength)); //$NON-NLS-1$
		}
